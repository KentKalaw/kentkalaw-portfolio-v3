export const themeSwitcherCode = `"use client";
...
export const usageExample = `import { ThemeSwitcher } from "@/components/theme-switcher";
...
export const extraStepCode1 = `"use client"
...
export const extraStepCode2 = `import { ThemeProvider } from "@/components/theme-provider"
