            ...
            {latestPosts.map((post, index) => (
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1 mb-1">
                      <span className="font-semibold text-xs text-gray-900 dark:text-gray-100">Kent Kalaw</span>
                      <svg
                viewBox="0 0 22 22"
              ...
              >
                ...
                />
                    ...
                    <p className="text-xs text-gray-900 dark:text-gray-100 leading-relaxed line-clamp-3">
                      {post.content}
                    </p>
                  </div>
                </div>
