  ...
  return (
    <Panel className="animate-fade-in animate-delay-400">
      ...
      <PanelContent className="space-y-4 text-justify text-sm leading-relaxed md:text-base">
        <p className="text-justify text-2xl leading-snug font-semibold md:text-3xl">
        ...
        <p className="text-muted-foreground text-justify">
          ...
          development. I build responsive, production-ready applications using
          current frameworks and scalable architecture patterns.
        </p>
